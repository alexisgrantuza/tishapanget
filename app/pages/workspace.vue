                ...
                <div class="relative" ref="createBoardRef">
                  ...
                  >
                    <div
                      ...
                      class="absolute -top-2 left-72 mt-1 w-80 z-50 rounded-xl bg-card border border-border/50 shadow-2xl backdrop-blur-xl supports-[backdrop-filter]:bg-card/95"
                    >
                      <!-- Dropdown Header -->
                      <div
                      ...
                      <div class="p-4 space-y-4">
                        ...
                        <div>
                          ...
                          <div class="grid grid-cols-6 gap-1.5">
                            <!-- Photo Backgrounds -->
                            <div
                              v-for="photo in photoBackgrounds"
                              :key="photo.id"
